...
public class TonePickerSplash extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
	    ...
	    Uri u = Uri.parse(Settings.System.getString(getContentResolver(), Settings.System.RINGTONE) );
	    i.putExtra(RingtoneManager.EXTRA_RINGTONE_EXISTING_URI, u);
        ...
        button.setOnClickListener(new Button.OnClickListener() {
          public void onClick(View v) {
            Intent i = new Intent(android.media.RingtoneManager.ACTION_RINGTONE_PICKER);
	    Uri u = Uri.parse(Settings.System.getString(getContentResolver(), Settings.System.NOTIFICATION_SOUND) );
	    i.putExtra(RingtoneManager.EXTRA_RINGTONE_EXISTING_URI, u);
